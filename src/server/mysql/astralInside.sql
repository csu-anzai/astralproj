...
CREATE DEFINER=`root`@`localhost` FUNCTION `getFilterCompaniesForUser` (`userID` INT(11), `types` JSON, `dateStart` VARCHAR(19) CHARSET utf8, `dateEnd` VARCHAR(19) CHARSET utf8) RETURNS JSON NO SQL
BEGIN
