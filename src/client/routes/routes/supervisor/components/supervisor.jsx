...
export default class Supervisor extends React.Component {
  constructor(props){
    ...
    this.changeDataChannels = this.changeDataChannels.bind(this);
  }
  createFile(){
    this.props.dispatch({
      type: "procedure",
  ...
  changeChannel(event, key, payload){
    this.props.dispatch({
      type: "query",
      socket: true,
      data: {
  ...
  changeDataChannels(event, key, payload){
    this.props.dispatch({
      type: "query",
      socket: true,
      data: {
      ...
      </div>
      {
        this.state.selectedIndex == 0 ?
          ...
          <SelectField
            ...
            value={this.props.state.statistic && this.props.state.statistic.channels}
          >{this.props.state.channels && this.props.state.channels.map((c, key) => (
            <MenuItem value={c.channel_id} key={key} primaryText={c.channel_description} />
          ))}</SelectField>
          ...
          <div style = {partStyle}>
            <SelectField
              floatingLabelText="Канал"
              multiple={true}
              onChange={this.changeDataChannels}
              value={this.props.state.statistic && this.props.state.statistic.dataChannels}
            >{this.props.state.channels && this.props.state.channels.map((c, key) => (
              <MenuItem value={c.channel_id} key={key} primaryText={c.channel_description} />
            ))}</SelectField>
